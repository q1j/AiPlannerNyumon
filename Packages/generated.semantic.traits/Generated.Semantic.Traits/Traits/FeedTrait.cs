...
namespace Generated.Semantic.Traits
{
    ...
    [AddComponentMenu("Semantic/Traits/FeedTrait (Trait)")]
    [RequireComponent(typeof(SemanticObject))]
    public partial class FeedTrait : MonoBehaviour, ITrait
    {
        ...
        public void Convert(Entity entity, EntityManager destinationManager, GameObjectConversionSystem _)
        {
            ...
            if (!destinationManager.HasComponent(entity, typeof(FeedTraitData)))
            {
                destinationManager.AddComponent<FeedTraitData>(entity);
            }
        }
        ...
        void OnDestroy()
        {
            ...
            {
                m_EntityManager.RemoveComponent<FeedTraitData>(m_Entity);
        ...
        void OnDrawGizmos()
        {
            TraitGizmos.DrawGizmoForTrait(nameof(FeedTraitData), gameObject,null);
        }
#endif
    }
}
