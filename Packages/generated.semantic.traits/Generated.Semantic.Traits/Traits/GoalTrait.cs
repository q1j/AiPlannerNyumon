...
namespace Generated.Semantic.Traits
{
    ...
    [AddComponentMenu("Semantic/Traits/GoalTrait (Trait)")]
    [RequireComponent(typeof(SemanticObject))]
    public partial class GoalTrait : MonoBehaviour, ITrait
    {
        ...
        public void Convert(Entity entity, EntityManager destinationManager, GameObjectConversionSystem _)
        {
            ...
            if (!destinationManager.HasComponent(entity, typeof(GoalTraitData)))
            {
                destinationManager.AddComponent<GoalTraitData>(entity);
            }
        }
        ...
        void OnDestroy()
        {
            ...
            {
                m_EntityManager.RemoveComponent<GoalTraitData>(m_Entity);
        ...
        void OnDrawGizmos()
        {
            TraitGizmos.DrawGizmoForTrait(nameof(GoalTraitData), gameObject,null);
        }
#endif
    }
}
